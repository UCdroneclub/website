...
const OFFICERS_DEFAULT = [
  ...
  { name: 'Thomas Burkholder', role: 'Co-Founder', spec: 'cool', bio: '2nd-year Mechanical Engineer. Owns more LiPo bags than couches.' },
  { name: 'New Person',        role: 'Member',     spec: 'cool', bio: 'Write their bio here.' },
];
